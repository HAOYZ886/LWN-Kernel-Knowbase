---
title: The 3.16 merge window concludes
url: https://lwn.net/Articles/602212/
date: "June 18, 2014"
category: "Releases-3.16"
author: "By Jake Edge June 18, 2014"
---
...
On June 15, Linus Torvalds put out the [3.16-rc1](<https://lwn.net/Articles/602409/>) prepatch and closed the merge window for this cycle. From here on in, features are unlikely to be added as fixes and stabilization patches should predominate. 

At this point, Torvalds has merged 11,364 non-merge commits for 3.16. That's around 3,200 since [last week's look](<https://lwn.net/Articles/601726/>) (and a total of nearly 6,000 since [part 1](<https://lwn.net/Articles/601152/>) of our merge window coverage). The last two merge windows have been two of the top three windows in terms of commits, with 3.16 in third place behind 3.10 (11,963) and 3.15 (12,034). We will have to see if the trend continues and we get 11,000–12,000 patches for 3.17 and beyond. 
...
In any case, here are some of the more significant changes that users will see in 3.16: 
  ...
  * The secure computing (seccomp) [BPF filters](<https://lwn.net/Articles/599755/>) are now just-in-time (JIT) compiled. 
  * Support for [TCP fast open](<https://lwn.net/Articles/508865/>) over IPv6 has been added. 
...
Changes of interest to kernel developers include: 
  ...
  * The [`Documentation/mutex-design.txt`](<https://lwn.net/Articles/602393/>) file has been extensively updated to better reflect today's reality. 
