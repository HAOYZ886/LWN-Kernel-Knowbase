...
Chances are, though, that this standoff will be resolved more quickly than people might expect. The AMD developers were not unaware of the problems and, it seems, not unwilling to fix them. Deucher [said](<https://lwn.net/Articles/708911/>): 
...
Some work has indeed been done since the early posting of this patch set; and, it is said, about one-third of the midlayer code is gone. Vetter [made it clear](<https://lwn.net/Articles/709000/>) that this work had been seen and appreciated: 
