---
title: "2.6.31 merge window, week 1"
url: https://lwn.net/Articles/336953/
date: "June 17, 2009"
category: "Releases-2.6.31"
author: "By Jonathan Corbet June 17, 2009"
---
...
The process of merging patches for 2.6.31 has begun. As of this writing, 6220 non-merge changesets have been added to the mainline. Some of the more interesting, user-visible change include: 
  ...
  * [Passive OS fingerprinting](<https://lwn.net/Articles/336921/>) has been added to the netfilter code. 
...
This function will decrement `cnt` and, if `cnt` reaches zero, it will acquire the given `lock`. 
  ...
  * [Tree read-copy update](<https://lwn.net/Articles/305782/>) (RCU) is now the default, though Classic RCU is still available. 
  ...
  * Debugfs has had all of its references throughout the tree turned into `/sys/kernel/debug/` in both documentation and code. In addition, LWN's [updated guide to debugfs](<https://lwn.net/Articles/334546/>) was added to the Documentation directory. 
  ...
  * The TTM GPU memory manager ([covered](<https://lwn.net/Articles/283793/>) a bit over a year ago) has been merged. 
