---
title: 4.11 Merge window part 2
url: https://lwn.net/Articles/715781/
date: "March 1, 2017"
category: "Releases-4.11"
author: "By Jonathan Corbet March 1, 2017"
---
...
Changes visible to kernel developers include: 
  ...
  * The LZ4 compression module [has been replaced](<https://lwn.net/Articles/713175/>) with a newer, better-performing version. 
  ...
  * The [IDR](<https://lwn.net/Articles/536293/>) and IDA mechanisms have been extensively rewritten and are now based on the kernel's [radix tree](<https://lwn.net/Articles/175432/>) implementation. See [this commit](<https://git.kernel.org/linus/cf393195c3ba5d4c0a8e237eb00f7ef104876ee5>) for a brief description of what was done and why. 

At this point, the flow of patches has slowed considerably, so it is probably safe to assume that almost all of the major changes for 4.11 have been merged. One exception might be the [`sched.h` rework](<https://lwn.net/Articles/713890/>) which, if it is merged in this cycle, will go in right at the end of the merge window.
