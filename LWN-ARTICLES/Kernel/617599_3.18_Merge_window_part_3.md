...
Changes visible to kernel developers include: 
  ...
  * There is a new "mailbox" framework for hardware-based interprocessor communication mechanisms. See [Documentation/mailbox.txt](<https://lwn.net/Articles/617602/>) for (some) more information. 
