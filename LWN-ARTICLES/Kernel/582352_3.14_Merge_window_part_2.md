---
title: 3.14 Merge window part 2
url: https://lwn.net/Articles/582352/
...
As of this writing, almost 8,600 non-merge changesets have been pulled into the mainline repository for the 3.14 development cycle — 5,300 since [last week's merge window summary](<https://lwn.net/Articles/581657/>). As can be seen from the list below, quite a bit of new functionality has been added to the kernel in the last week. Some of the more significant, user-visible changes merged include: 

  * The [event triggers](<https://lwn.net/Articles/556186/>) feature has been added to the tracing subsystem. See [this commit](<http://git.kernel.org/linus/ac38fb8582d86ba887b5d07c0912dec135bf6931>) for some information on how to use this feature. 

  * The user-space probes (uprobes) subsystem has gained support for a number of "fetch methods" providing access to data on the stack, from process memory, and more. See [the patchset posting](<https://lwn.net/Articles/577142/>) for more information. 
  ...
  * The Berkeley Packet Filter subsystem has acquired a couple of new user-space tools: a debugger and a simple assembler. See the newly updated [Documentation/networking/filter.txt](<https://lwn.net/Articles/582493/>) for more information. 
