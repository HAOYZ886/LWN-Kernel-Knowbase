---
title: "Compile-time stack validation"
url: https://lwn.net/Articles/658333/
date: "September 30, 2015"
category: Live patching
author: "By Jonathan Corbet September 30, 2015"
---
...
Some developers might have given up at this point. Josh Poimboeuf, instead, set out to find a way to make the call stack valid at all times and keep it that way; the result is the "compile-time stack metadata validation" patch set, in [its 13th revision](<https://lwn.net/Articles/658341/>) as of this writing. This work adds a new tool (called `stacktool`) that checks the entire kernel as part of the build process to be sure that all code obeys the rules for maintaining the call stack. 
