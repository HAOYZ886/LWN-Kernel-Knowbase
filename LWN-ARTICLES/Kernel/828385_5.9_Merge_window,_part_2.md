---
title: "5.9 Merge window, part 2"
url: https://lwn.net/Articles/828385/
date: "August 17, 2020"
category: "Releases-5.9"
author: "By Jonathan Corbet August 17, 2020"
---
...
By the time Linus Torvalds [released 5.9-rc1](<https://lwn.net/Articles/828894/>) and closed the merge window for this cycle, 12,866 non-merge changesets had been pulled into the mainline repository. Nearly 9,000 of those came in after [the first 5.9 merge-window summary](<https://lwn.net/Articles/828120/>) was written. Clearly the kernel-development community remains busy. Much of what was merged takes the form of cleanups and restructuring, as always, but there was also a substantial set of new features. 
...
#### Core kernel
  ...
  * The [proactive compaction](<https://lwn.net/Articles/817905/>) patches have been merged. They perform memory compaction in the background, hopefully increasing the supply of large pages available to the kernel. 

#### Filesystems and block I/O

  * The SCSI subsystem can now make use of encryption hardware on UFS controllers to implement [inline encryption](<https://lwn.net/Articles/797309/>). 
...
#### Internal kernel changes
  ...
  * The way that priorities are assigned to kernel threads [has been significantly reworked](<https://lwn.net/Articles/818388/>). The new API brings a lot more consistency in how realtime priorities are assigned across the kernel. 
  ...
  * Kernel modules that import symbols from proprietary modules will themselves be marked as tainted, eliminating their ability to access GPL-only symbols in the rest of the kernel. This change, along with its motivation, is explained in [this article from July](<https://lwn.net/Articles/827596/>). 
