...
url: https://lwn.net/Articles/606004/
date: "July 23, 2014"
category: "Control groups-LWNs guide to"
author: "July 23, 2014 This article was contributed by Neil Brown Control groups"
---
...
When the `cpu` cgroup subsystem is used to request [group scheduling](<https://lwn.net/Articles/240474/>), these proportions must be calculated based on the group hierarchy, so some proportion will be given to a top-level group, and that is then shared among the processes and sub-groups in that group.
