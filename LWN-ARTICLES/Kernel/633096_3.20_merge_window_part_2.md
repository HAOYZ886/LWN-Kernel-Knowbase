---
title: 3.20 merge window part 2
url: https://lwn.net/Articles/633096/
date: "February 18, 2015"
category: "Releases-4.0"
author: "By Jonathan Corbet February 18, 2015"
---
...
As of this writing, 7,849 non-merge changesets have been pulled into the mainline repository for this development cycle; about 4,200 of those have come in since [last week's summary](<https://lwn.net/Articles/632761/>) was written. Some of the more interesting user-visible changes found in those 4,200 patches include: 
  ...
  * The [persistent storage subsystem](<https://lwn.net/Articles/434821/>) can optionally provide a new special file (`/dev/pmsg0`) allowing user-space programs to log data into the store. 

  * The Smack security module can now interface with the netfilter system, using security labels to filter packets. 

  * The ubifs filesystem now has [multiqueue block layer](<https://lwn.net/Articles/552904/>) support (increasing its performance) and support for `security.*` extended attributes (making security module support possible). 
  ...
  * The [nonvolatile memory support patches](<https://lwn.net/Articles/610174/>) have been merged, making it possible to host filesystems in persistent memory with good performance. 
  ...
  * The [lazytime](<https://lwn.net/Articles/621046/>) filesystem option (with support in ext4, initially) has been merged. Lazytime allows accurate tracking of file access times without creating lots of write I/O to the filesystem. 
...
Changes visible to kernel developers include: 
  ...
  * The [kernel address sanitizer (KASan)](<https://lwn.net/Articles/612153/>) has been merged. KASan monitors kernel memory references in an attempt to catch code reaching into memory it has no business touching. For now, KASan only works on the x86_64 architecture, and memory hotplug must be disabled. 
