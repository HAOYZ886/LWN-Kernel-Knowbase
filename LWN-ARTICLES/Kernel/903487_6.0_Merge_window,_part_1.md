---
title: "6.0 Merge window, part 1"
url: https://lwn.net/Articles/903487/
date: "August 5, 2022"
category: "Releases-6.0"
author: "By Jonathan Corbet August 5, 2022"
---
...
#### Architecture-specific
  ...
  * The arm64 architecture can now swap transparent huge pages without the need to split them to base pages first. This feature is incompatible with the [memory tagging extension](<https://lwn.net/Articles/834289/>), though. 

#### Core kernel

  * The energy-margin heuristic that limited process migration across CPUs [has been removed](<https://lwn.net/Articles/899303/>), resulting in better energy utilization overall. 
  ...
  * [Zero-copy network transmission](<https://lwn.net/Articles/879724/>) is also now supported in io_uring. 
...
#### Filesystems and block I/O
  ...
  * A new version (version 2) of [the Btrfs "send" protocol](<https://lwn.net/Articles/506244/>) has been added. It supports sending data in larger chunks, sending raw compressed extents, and including more metadata. Naturally, the version 1 protocol is still supported on both ends. 
