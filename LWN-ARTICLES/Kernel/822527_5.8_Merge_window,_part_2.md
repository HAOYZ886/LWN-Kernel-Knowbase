---
title: "5.8 Merge window, part 2"
url: https://lwn.net/Articles/822527/
date: "June 14, 2020"
category: "Releases-5.8"
author: "By Jonathan Corbet June 14, 2020"
---
...
#### Core kernel
  ...
  * After a couple of years of work, the [generalized kernel event-notification mechanism](<https://lwn.net/Articles/760714/>) has been merged. See [this commit](<https://git.kernel.org/linus/6c3297841472>) for an overview and [this commit](<https://git.kernel.org/linus/c73be61cede5>) for documentation on the new subsystem. 
...
#### Security-related
  ...
  * Mitigations for the ["special register buffer data sampling" hardware vulnerability](<https://lwn.net/Articles/822595/>) have been merged; see [Documentation/admin-guide/hw-vuln/special-register-buffer-data-sampling.rst](<https://lwn.net/Articles/822596/>) for more information. 
...
#### Internal kernel changes
  ...
  * The [KCSAN](<https://lwn.net/Articles/816850/>) data-race detector has been merged. Note that this tool requires the (not yet released) Clang 11 compiler to work properly; see [this changelog](<https://git.kernel.org/linus/b791d1bdf921>) for more information. 
