---
title: 4.1 development statistics
url: https://lwn.net/Articles/646942/
date: "June 3, 2015"
...
The [4.1-rc6](<https://lwn.net/Articles/646821/>) prepatch is out, and things look on track for an on-schedule 4.1 release — unless, of course, [Linus's vacation plans](<https://lwn.net/Articles/645775/>) get in the way. But the kernel development community doesn't stop, even when Linus does, so it seems like about time to have a look at some development statistics for this kernel cycle. 4.1 was a fairly typical development cycle with few surprises. 
