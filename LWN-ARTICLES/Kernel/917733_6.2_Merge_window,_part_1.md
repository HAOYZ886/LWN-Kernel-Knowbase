---
title: "6.2 Merge window, part 1"
url: https://lwn.net/Articles/917733/
date: "December 15, 2022"
category: "Releases-6.2"
author: "By Jonathan Corbet December 15, 2022"
---
...
#### Architecture-specific
  ...
  * There is a new sysctl knob to control how x86 systems respond to processes executing split locks; see [this commit](<https://git.kernel.org/linus/727209376f49>) for an overview and [this article](<https://lwn.net/Articles/911219/>) for the background. 
...
#### Core kernel
  ...
  * More Rust infrastructure code has been merged; see [this article](<https://lwn.net/Articles/914458/>) for details. 
...
#### Filesystems and block I/O
  ...
  * Squashfs can also now handle [ID-mapped mounts](<https://lwn.net/Articles/896255/>). 
...
#### Miscellaneous
  ...
  * The new `rv` tool can be used to control the operation of the [runtime verification](<https://lwn.net/Articles/857862/>) subsystem. See [this documentation commit](<https://git.kernel.org/linus/afc70ccb9628>) for details. 
...
#### Internal kernel changes
  ...
  * As described in [this article](<https://lwn.net/Articles/911914/>), the `char` type will now default to `unsigned` on all architectures. 
