---
title: 3.8 Merge window part 1
url: https://lwn.net/Articles/528893/
date: "December 12, 2012"
category: "Releases-3.8"
author: "By Jonathan Corbet December 12, 2012"
---
...
The 3.8 merge window looks to be an interesting time. In theory, it closes just before the Christmas holiday, though Linus has threatened to start his celebrations early. Despite the possibly shortened window, there are, [according to linux-next maintainer Stephen Rothwell](<https://lwn.net/Articles/528906/>), ""more commits in linux-next than ever before."" So expect to see a lot of changes flowing into the mainline in a relatively short period of time. 
...
As of this writing, some 3800 of those changes have been merged by Linus. The most significant user-visible changes include: 
  ...
  * The [cpuidle subsystem](<https://lwn.net/Articles/384146/>) is now able to associate different drivers with each CPU. This capability is needed to support asymmetric architectures like big.LITTLE. 
...
Changes visible to kernel developers include: 
  ...
  * The UIO driver subsystem has a new generic platform driver allowing UIO devices to access memory allocated by [CMA](<https://lwn.net/Articles/486301/>) or the IOMMU subsystem. 
  ...
  * The [callback-free RCU implementation](<https://lwn.net/Articles/522262/>) has been merged, allowing the offloading of some read-copy-update overhead from a subset of CPUs in the system. 
