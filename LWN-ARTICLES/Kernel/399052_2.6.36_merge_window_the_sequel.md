---
title: "2.6.36 merge window: the sequel"
url: https://lwn.net/Articles/399052/
date: "August 11, 2010"
category: "Releases-2.6.36"
author: "By Jonathan Corbet August 11, 2010"
---
...
This function will sleep (uninterruptibly) for a period between `min` and `max` microseconds. It is based on hrtimers, so the timing will be more precise than obtained with `msleep()`. 
  ...
  * The Video4Linux2 layer has gained a new framework which simplifies the handling of controls; see [this commit](<http://git.kernel.org/linus/0996517cf8eaded69b8502c8f5abeb8cec62b6d4>) and [Documentation/video4linux/v4l2-controls.txt](<https://lwn.net/Articles/399547/>) for details. 
  ...
  * The domain name resolution code has been pulled out of the CIFS filesystem and made generic. It works by using the key mechanism to request DNS resolution from user space; see [Documentation/networking/dns-resolver.txt](<https://lwn.net/Articles/399546/>) for details. 
