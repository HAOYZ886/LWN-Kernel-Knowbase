...
url: https://lwn.net/Articles/1035727/
date: "September 1, 2025"
category: "Architectures-32-bit systems"
author: "By Jonathan Corbet September 1, 2025 OSS EU"
---
...
> [![\[History of
non-embedded 32-bit platforms\]](https://static.lwn.net/images/conf/2025/osseu/arnd-non-embedded-sm.png)](<https://lwn.net/Articles/1035730/#nonembed>)
...
> [![\[History of
pre-armv7 platforms\]](https://static.lwn.net/images/conf/2025/osseu/arnd-pre-v7-sm.png)](<https://lwn.net/Articles/1035730/#prev7>)
...
Another approach is the proposed "densemem" memory model, which does some fancy remapping to close holes in the physical address space. Densemem can support up to 2GB and is needed [to replace the SPARSEMEM memory model](<https://lwn.net/Articles/974517/>), the removal of which which will eventually be necessary in any case. This work has to be completed before high memory can be removed; Bergmann said that he would be interested in hearing from potential users of the densemem approach. 
...
Then, there is [the year-2038 problem](<https://lwn.net/Articles/776435/>), which he spent several years working on. The kernel-side work was finished in 2020; the musl C library was updated that same year, and the GNU C Library followed the year after. Some distributors have been faster than others to incorporate this work; Debian and Ubuntu have only become year-2038-safe this year. 
...
The [slides for this talk](<https://static.sched.com/hosted_files/osseu2025/75/32-bit%20Linux%20in%202025%20%28OSS%20Europe%29.pdf>) are available. The curious may also want to look at [Bergmann's 2020 take](<https://lwn.net/Articles/838807/>) on this topic. 
