---
title: 3.1 merge window part 1
url: https://lwn.net/Articles/452748/
date: "July 27, 2011"
category: "Releases-3.1"
author: "By Jonathan Corbet July 27, 2011"
---
...
User-visible changes merged for 3.1 include: 
  ...
  * The BATMAN-adv protocol ([covered here](<https://lwn.net/Articles/426947/>) in February) has gained a better roaming mechanism, improved client announcement, and some performance improvements. 
  ...
  * The [BPF JIT compiler](<https://lwn.net/Articles/437981/>) now supports the PowerPC architecture. 
  ...
  * The `lseek()` system call now implements [`SEEK_HOLE` and `SEEK_DATA`](<https://lwn.net/Articles/440255/>); these operations can be used to locate extended blocks of zeroes within files. 
...
Changes visible to kernel developers include: 
  ...
  * The networking layer has gained generic support for near-field communication (NFC) devices. See [Documentation/networking/nfc.txt](<https://lwn.net/Articles/452753/>) for details. 
