---
title: "O_*SYNC"
url: https://lwn.net/Articles/350219/
date: "September 1, 2009"
category: Filesystems; O SYNC
author: "By Jonathan Corbet September 1, 2009"
---
...
Christoph [outlined](<https://lwn.net/Articles/350227/>) the likely course of action. Internally, `O_SYNC` will become `O_DSYNC`, and the `open()` flag which is currently `O_SYNC` will come to mean `O_DSYNC`. The `open()` system call will then take a new flag (name unknown; `O_FULLSYNC` and `O_ISYNC` have been suggested) which will be hidden from applications. At the glibc level, applications will see this: 
