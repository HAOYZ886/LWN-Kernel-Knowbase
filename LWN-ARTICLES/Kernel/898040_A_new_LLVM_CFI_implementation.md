---
title: A new LLVM CFI implementation
url: https://lwn.net/Articles/898040/
date: "June 17, 2022"
category: "Releases-6.1; Security-Control-flow integrity"
author: "By Jonathan Corbet June 17, 2022"
---
...
it will generate a corresponding symbol defined as the resulting hash value; in this case, the symbol would be `__kcfi_typeid_mcam_v4l_open`. The existence of these symbols means that the preambles for assembly functions can be generated automatically via [some tweaks](<https://lwn.net/ml/linux-kernel/20220610233513.1798771-7-samitolvanen@google.com/>) to the macros already used to define those functions. 
