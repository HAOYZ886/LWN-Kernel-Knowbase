...
date: "July 9, 2014"
category: "Development model-User-space ABI; Dnotify; Inotify"
author: "July 9, 2014 This article was contributed by Michael Kerrisk . Filesystem notification"
---
...
[Filesystem notification](<https://lwn.net/Articles/605313/>)
...
Those problems led to the creation of the first in-kernel implementation of a filesystem notification API, dnotify, which was implemented by Stephen Rothwell (these days, the maintainer of the [linux-next tree](<https://lwn.net/Articles/571980/>)) and which first appeared in Linux 2.4.0 (in 2001). 
...
A simple example of the use of dnotify can be found [here](<https://lwn.net/Articles/604696/>). 
