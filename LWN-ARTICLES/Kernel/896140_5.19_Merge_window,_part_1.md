---
title: "5.19 Merge window, part 1"
url: https://lwn.net/Articles/896140/
date: "May 27, 2022"
category: "Releases-5.19"
author: "By Jonathan Corbet May 27, 2022"
---
...
#### Architecture-specific
  ...
  * The x86 [split-lock detection mechanism](<https://lwn.net/Articles/790464/>) has been made a bit stronger; rather than just warning (by default) when a process uses split locks, the kernel will slow that process down considerably. That should preserve the performance of the rest of the system and, with luck, cause the offending application to be fixed. 
  ...
  * The xtensa architecture has gained support for a number of features, including SMP coprocessors, [KCSAN](<https://lwn.net/Articles/802128/>), hibernation, and more. 
...
#### Networking
  ...
  * The [BIG TCP patch set](<https://lwn.net/Articles/884104/>) has been merged; this work allows for the sending of huge IPv6/TCP packets on data-center networks. 
  * The addition of [packet-drop annotations](<https://lwn.net/Articles/885729/>) continues, improving an administrator's visibility into why network packets are not making it through the system. 
...
#### Security-related
  ...
  * The [structure randomization](<https://lwn.net/Articles/722293/>) hardening feature is now available with the Clang compiler as of version 15\. 
...
#### Internal kernel changes
  ...
  * The [transition to memory folios](<https://lwn.net/Articles/893512/>) continues; [this pull request](<https://git.kernel.org/linus/fdaf9a5840ac>) converted a number of address-space operations over to the new(ish) type. 
  ...
  * The work to move the printing of kernel messages to per-console threads (described in [this 2019 article](<https://lwn.net/Articles/800946/>)) has finally been merged. This should prevent slow consoles from blocking logging or creating large latencies in general. Also, the [`printk()` indexing feature](<https://lwn.net/Articles/857148/>) has now [been documented](<https://git.kernel.org/linus/a5c7a39f508a>). 
