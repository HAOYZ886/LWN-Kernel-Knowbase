---
title: The 2.6.39 merge window concludes
url: https://lwn.net/Articles/435716/
date: "March 29, 2011"
...
There have been just over 2,200 non-merge changesets pulled into the mainline since [the second installment](<https://lwn.net/Articles/434637/>) in this series; that makes 8,757 total changes for this development cycle. The 2.6.39 merge window is now closed, so the feature set for this kernel development cycle should be complete. User-visible changes merged in the final part of the merge window include: 

  * Beginning [user namespace](<https://lwn.net/Articles/420624/>) support has been merged. User namespaces are a sort of container where processes can safely be given root access within the container without being able to affect the rest of the system. Full container support is a long-term project, but the user namespace patches get the kernel one step closer. 
...
Changes visible to kernel developers include: 
  ...
  * The [media controller subsystem](<https://lwn.net/Articles/415714/>), intended to allow the system to export information about the topology of complex media subsystems to user space, has been merged. 
