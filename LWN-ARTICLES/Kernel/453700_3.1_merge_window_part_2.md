---
title: 3.1 merge window part 2
url: https://lwn.net/Articles/453700/
date: "August 3, 2011"
category: "Releases-3.1"
author: "By Jake Edge August 3, 2011"
---
...
Changes visible to kernel developers include: 
  ...
  * EFI non-volatile storage can now be used as a [pstore](<https://lwn.net/Articles/434821/>) backend to persistently store log messages or other information. 

One notable patch set that will not be merged this time around is the [Native Linux KVM tool](<https://lwn.net/Articles/438182/>). Torvalds [decided](<https://lwn.net/Articles/453957/>) that he needed more convincing before merging it: 
