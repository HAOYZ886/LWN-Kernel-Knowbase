---
title: "5.16 Merge window, part 1"
url: https://lwn.net/Articles/874683/
date: "November 4, 2021"
category: "Releases-5.16"
author: "By Jonathan Corbet November 4, 2021"
---
...
#### Architecture-specific
  ...
  * RISC-V now has support for virtualization with KVM, an improvement that [took rather longer](<https://lwn.net/Articles/856685/>) than the developers would have liked. 
...
#### Core kernel
  ...
  * The `futex_waitv()` system call (described in [this article](<https://lwn.net/Articles/866112/>)) has been merged. 
...
#### Security-related
  ...
  * Most of the work for [strict `memcpy()` bounds checking](<https://lwn.net/Articles/864521/>) has been merged. The actual patches enabling bounds checking across the kernel have not (yet) been merged, though, pending fixes for some remaining problems. 
  * The io_uring subsystem has [gained audit support](<https://lwn.net/Articles/858023/>). 
