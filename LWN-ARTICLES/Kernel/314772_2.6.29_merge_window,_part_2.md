---
title: "2.6.29 merge window, part 2"
url: https://lwn.net/Articles/314772/
...
and continue with the bisection process as usual. 
  ...
  * There is [a portion of the kernel history](<https://lwn.net/Articles/314774/>) which contains a badly broken version of reiserfs. Again, only developers running kernels from arbitrary points in the history will be affected by this problem; if you run reiserfs, though, read the summary and take care. 
...
So what else was merged for 2.6.29? User-visible changes include: 
  ...
  * There is now kernel support for WiMAX networking. The current code supports Intel's Wireless Wimax Connection 2400m devices, but others are expected for the future. See [this documentation file](<https://lwn.net/Articles/314787/>) for a bit of information on the WiMAX stack. 
