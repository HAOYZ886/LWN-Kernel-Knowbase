---
title: "Low-level tracing plumbing"
url: https://lwn.net/Articles/300992/
date: "September 30, 2008"
category: "Development tools-Kernel tracing; Tracing"
author: "By Jonathan Corbet September 30, 2008"
---
...
The most direct (if not most politic) [answer](<https://lwn.net/Articles/301011/>) to that question was probably posted by Peter Zijlstra: 
...
Deleting relayfs would not be that hard; there are only a couple of users, currently. But relayfs developer Tom Zanussi [is not convinced](<https://lwn.net/Articles/301012/>) that the problems with relayfs are severe enough to justify tossing it out and starting over. He has posted [a series of patches](<https://lwn.net/Articles/301014/>) cleaning up the relayfs API and addressing some of its performance problems. At this point, though, it is not clear that anybody is really looking at that work; it has not received much in the way of comments. 
