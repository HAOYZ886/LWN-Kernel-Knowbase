---
title: "2.6 and the user-space ABI"
url: https://lwn.net/Articles/234133/
date: "May 15, 2007"
...
Linus [isn't happy](<https://lwn.net/Articles/234358/>) about the forced lm_sensors upgrade; he has asked for a way to avoid that requirement. In response, i2c maintainer Jean Delvare [raised some misgivings](<https://lwn.net/Articles/234359/>) about the stable ABI policy: 
...
Those comments notwithstanding, Linux has managed to maintain user-space ABI compatibility quite nicely for many years. There are certainly exceptions, but they are few enough and far enough between that each one stands out. But, as [Christoph Hellwig points out](<https://lwn.net/Articles/234364/>), the situation is not perfect: 
