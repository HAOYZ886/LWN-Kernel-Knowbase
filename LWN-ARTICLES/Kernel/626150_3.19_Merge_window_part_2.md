---
title: 3.19 Merge window part 2
url: https://lwn.net/Articles/626150/
...
[Last week's 3.19 merge window summary](<https://lwn.net/Articles/625146/>) noted that things had gotten off to a slow start. Linus has made up for lost time since then, though; as of this writing, just over 10,400 changesets have been pulled into the mainline repository — over 8,000 since last week. Needless to say, those changes represent a great deal of fixes and new work. The most significant user-visible changes include: 
  ...
  * [Device tree overlay](<https://lwn.net/Articles/616859/>) support has been merged. This feature should make life easier for developers working on systems with "shields" or other types of daughterboards that need to be worked into the device tree at system boot time. 
  ...
  * It is now possible to [attach enhanced BPF programs to network sockets](<https://lwn.net/Articles/625224/>). For now, this capability can only be used for statistics gathering, but other applications should become possible in future development cycles. 
...
Changes visible to kernel developers include: 
  ...
  * The virtio subsystem has seen a lot of work to make it comply with the [virtio 1.0 standard](<https://lwn.net/Articles/580186/>). 
  ...
  * Support for the ARM "Coresight" tracing mechanism has been added to the kernel. See [Documentation/trace/coresight.txt](<https://lwn.net/Articles/626463/>) for information about this subsystem and how to work with it. 
