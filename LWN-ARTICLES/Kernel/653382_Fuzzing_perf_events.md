---
title: Fuzzing perf_events
url: https://lwn.net/Articles/653382/
date: "August 5, 2015"
category: "Development tools-Fuzz testing; Performance monitoring"
author: "August 5, 2015 This article was contributed by Vince Weaver"
---
...
Much of the trickiness of the perf_event interface is due to the way it interacts with deep kernel internals. There are software events that count performance-critical operations such as context switches. The overflow interrupts are handled as non-maskable interrupts (NMIs) on many systems, which are often difficult to set up and tricky to debug. All user breakpoint support is handled by perf_event, and there are also interfaces for creating ftrace events and attaching [eBPF](<https://lwn.net/Articles/603983/>) filters. The wide scope of the perf_event code allows more chances for code to go wrong. 
