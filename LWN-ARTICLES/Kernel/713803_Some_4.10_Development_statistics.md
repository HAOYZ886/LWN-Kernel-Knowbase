---
title: Some 4.10 Development statistics
url: https://lwn.net/Articles/713803/
...
Mauro Carvalho Chehab is the media subsystem maintainer, and much of his work this time around was focused there. He also, however, did a lot of work in the ongoing process of [converting the kernel's documentation to Sphinx](<https://lwn.net/Articles/692704/>) and organizing it. Chris Wilson works on the Intel i915 driver, Arnd Bergmann made fixes all over the kernel tree, Christoph Hellwig contributed a lot of changes in the block and filesystem areas, and Ben Skeggs works on the Nouveau graphics driver. 
